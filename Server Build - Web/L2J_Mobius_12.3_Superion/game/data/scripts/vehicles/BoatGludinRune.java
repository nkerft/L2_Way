...
public class BoatGludinRune implements Runnable
{
	...
	public BoatGludinRune(Boat boat)
	{
		...
		ARRIVED_AT_GLUDIN_2 = new CreatureSay(ChatType.BOAT, 801, SystemMessageId.THE_FERRY_FOR_RUNE_HARBOR_WILL_LEAVE_IN_10_MIN);
		LEAVE_GLUDIN5 = new CreatureSay(ChatType.BOAT, 801, SystemMessageId.THE_FERRY_FOR_RUNE_HARBOR_WILL_LEAVE_IN_5_MIN);
		LEAVE_GLUDIN1 = new CreatureSay(ChatType.BOAT, 801, SystemMessageId.THE_FERRY_FOR_RUNE_HARBOR_WILL_LEAVE_IN_1_MIN);
		LEAVE_GLUDIN0 = new CreatureSay(ChatType.BOAT, 801, SystemMessageId.THE_FERRY_FOR_GLUDIN_HARBOR_WILL_BE_LEAVING_SOON_3);
		LEAVING_GLUDIN = new CreatureSay(ChatType.BOAT, 801, SystemMessageId.THE_FERRY_IS_LEAVING_FOR_GLUDIN_HARBOR_2);
		ARRIVED_AT_RUNE = new CreatureSay(ChatType.BOAT, 801, SystemMessageId.WELCOME_TO_RUNE_HARBOR);
		ARRIVED_AT_RUNE_2 = new CreatureSay(ChatType.BOAT, 801, SystemMessageId.THE_FERRY_FOR_GLUDIN_HARBOR_WILL_LEAVE_IN_10_MIN);
		LEAVE_RUNE5 = new CreatureSay(ChatType.BOAT, 801, SystemMessageId.THE_FERRY_FROM_RUNE_HARBOR_WILL_LEAVE_FOR_GLUDIN_HARBOR_IN_5_MIN);
		LEAVE_RUNE1 = new CreatureSay(ChatType.BOAT, 801, SystemMessageId.THE_FERRY_FROM_RUNE_HARBOR_WILL_LEAVE_FOR_GLUDIN_HARBOR_IN_1_MIN);
		LEAVE_RUNE0 = new CreatureSay(ChatType.BOAT, 801, SystemMessageId.THE_FERRY_FOR_GLUDIN_HARBOR_WILL_BE_LEAVING_SOON_2);
		LEAVING_RUNE = new CreatureSay(ChatType.BOAT, 801, SystemMessageId.THE_FERRY_IS_LEAVING_FOR_GLUDIN_HARBOR_2);
		BUSY_GLUDIN = new CreatureSay(ChatType.BOAT, 801, SystemMessageId.THE_FERRY_FROM_RUNE_HARBOR_FOR_GLUDIN_HARBOR_IS_DELAYED);
		BUSY_RUNE = new CreatureSay(ChatType.BOAT, 801, SystemMessageId.THE_FERRY_FROM_GLUDIN_HARBOR_TO_RUNE_HARBOR_HAS_BEEN_DELAYED);
		
		ARRIVAL_RUNE15 = new CreatureSay(ChatType.BOAT, 801, SystemMessageId.THE_FERRY_FROM_RUNE_HARBOR_WILL_ARRIVE_AT_GLUDIN_HARBOR_IN_15_MIN_2);
		ARRIVAL_RUNE10 = new CreatureSay(ChatType.BOAT, 801, SystemMessageId.THE_FERRY_FROM_RUNE_HARBOR_WILL_ARRIVE_AT_GLUDIN_HARBOR_IN_10_MIN_2);
		ARRIVAL_RUNE5 = new CreatureSay(ChatType.BOAT, 801, SystemMessageId.THE_FERRY_FROM_RUNE_HARBOR_WILL_ARRIVE_AT_GLUDIN_HARBOR_IN_5_MIN_2);
		ARRIVAL_RUNE1 = new CreatureSay(ChatType.BOAT, 801, SystemMessageId.THE_FERRY_FROM_RUNE_HARBOR_WILL_ARRIVE_AT_GLUDIN_HARBOR_IN_1_MIN_2);
		ARRIVAL_GLUDIN15 = new CreatureSay(ChatType.BOAT, 801, SystemMessageId.THE_FERRY_FROM_RUNE_HARBOR_WILL_ARRIVE_AT_GLUDIN_HARBOR_IN_15_MIN);
		ARRIVAL_GLUDIN10 = new CreatureSay(ChatType.BOAT, 801, SystemMessageId.THE_FERRY_FROM_RUNE_HARBOR_WILL_ARRIVE_AT_GLUDIN_HARBOR_IN_10_MIN);
		ARRIVAL_GLUDIN5 = new CreatureSay(ChatType.BOAT, 801, SystemMessageId.THE_FERRY_FROM_RUNE_HARBOR_WILL_ARRIVE_AT_GLUDIN_HARBOR_IN_5_MIN);
		ARRIVAL_GLUDIN1 = new CreatureSay(ChatType.BOAT, 801, SystemMessageId.THE_FERRY_FROM_RUNE_HARBOR_WILL_ARRIVE_AT_GLUDIN_HARBOR_IN_1_MIN);
